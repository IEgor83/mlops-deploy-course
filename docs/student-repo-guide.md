...
```bash
# Преподаватель выдал вам /task 1
...
# Бот проверит и ответит:
# ✅ Accepted! Score: 2/2
# Grades: @yourname 2 points for lesson 1

# Если есть ошибки:
# ❌ Failed: Missing reports/train_metrics.json
# → Исправляете и пушите изменения
# → Пишите боту заново: /submit 1
```
...
Перед тем как писать боту `/submit 1`, убедитесь:
